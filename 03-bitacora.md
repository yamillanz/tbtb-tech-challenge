...
| 17/09 | _pendiente: registrar en vivo al menos dos propuestas del asistente rechazadas o corregidas, con su motivo_ | | |

**Herramientas de IA utilizadas:** asistentes de código (declarar cuáles y en qué partes: análisis del extracto, redacción de documentos, propuestas de OpenSpec, código, pruebas, README). Se usa **OpenSpec** como metodología de trabajo: los cambios, tareas y deltas de especificación se registran en `openspec/` a medida que se resuelven. _Declaración a completar al cierre._
